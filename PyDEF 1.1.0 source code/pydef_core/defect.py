...
class Defect:
    ...
    def __init__(self, defect_type, atom, chem_pot):
        ...
        :param atom: list of atom(s) affected by the defect with the following pattern for each
                ...
                Ex: ['Cd (3)']
        :param chem_pot: list of chemical potentials corresponding to the atoms affected.
        """
    ...
    def get_defect_position(self, atoms_positions_host, atoms_positions_defect):
        """
